...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*NO WORRY BOSS I DEY🕷*";
 ...
 smd({
   ...
   try {
     ...
     if (!_0x49db20) {
       return await _0x7587f6.reply("_Reply to an image/video_");
     }
     if (!_0x11eeb1) {
       return await _0x7587f6.reply("_Need fileName, Example: document miles | caption_");
     }
 ...
 smd({
   ...
   use: "[text]",
   filename: __filename,
   info: "Chat with Miles"
 }, async (_0xe6d6e, _0x23f786) => {
   try {
     if (!_0x23f786) {
       return await _0xe6d6e.reply("'swings in' *" + _0xe6d6e.senderName + "*, xup gee?*");
     }
     const _0x55bb61 = {
       method: "POST",
       headers: {
 ...
 smd({
   ...
   type: "misc",
   info: "get bot response in details "
 }, async _0xdfc3ca => {
   try {
 ...
 smd({
   ...
   try {
     ...
     _0x446c27.send(_0x58d504 ? "*Bot's IP address is : _" + _0x58d504 + "_*" : "_No response from server!_");
   } catch (_0x2976b7) {
 ...
 smd({
   cmdname: "ss",
   type: "misc",
   info: "Screenshot a web"
 }, async (_0x4cdec8, _0x41dfb5) => {
   try {
     let _0x587b99 = _0x41dfb5.split(" ")[0].trim();
     if (!_0x587b99) {
       return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/Jordan-joelstar/Miles*");
     }
 ...
 let tmpUrl = "https://telegra.ph/file/f40799e1010d92c5717f4.jpg";
 const secmailData = {};
 smd({
   pattern: "tempmail",
   alias: [ "newmail", "tmail"],
   info: "Create tempory email address",
   type: "misc"
 }, async _0x10eae6 => {
   try {
