...
smd({
  ...
  try {
    ...
    let _0x20f704 = _0x44d3dd[1] && _0x44d3dd[1] !== "" ? _0x44d3dd[1] : "🅹🄾🆁🅳🄰🄽-🅹🄾🅴🄻🅂🅃🄰🆁";
...
smd({
  ...
  try {
    ...
    if (_0x11d586 && mtypes.includes(_0x11d586?.mtype || "need_Media")) {
      ...
      return _0x52caf7.reply("*_Reply an image werey🕷_*");
    }
  } catch (_0x165b2a) {
    return await _0x52caf7.error(_0x165b2a + "\n\ncmdName: circle\n", "*_Request Failed, Make sure You reply an image_*");
  }
});
smd({
  cmdname: "round",
  ...
  try {
    ...
    if (_0x5f32a5 && mtypes.includes(_0x5f32a5?.mtype || "need_Media")) {
      ...
      return _0x37c100.reply("*_Reply an image dude, an image!!!!!!👀_*");
    }
  } catch (_0x52baa5) {
...
smd({
  ...
  try {
    ...
    if (!_0x41bce8 || _0x41bce8?.locale == "") {
      return _0x46e4d3.send("*_Can't create mixture, try other emojies boss_*");
    } else {
...
smd({
  ...
  try {
    ...
    let {
      data: _0x3d14f3
    } = await axios.get("https://api.telegra.ph/createPage?access_token=d3b25feccb89e508a9114afb82aa421fe2a9712b963b387cc5ad71e58722&title=Suhail-Md+Bot&author_name=JORDAN-JOELSTAR_Tech_Info&content=[%7B\"tag\":\"p\",\"children\":[\"" + _0x531993.replace(/ /g, "+") + "\"]%7D]&return_content=true");
...
smd({
  ...
  if (!asta_mp4) {
    return m.reply("*_ Reply To Animated Sticker or gif_*");
  }
  const {
