...
const blockJid = ["" + (process.env.BLOCKJIDS || "@g.us"), ...(typeof global.blockJids === "string" ? global.blockJids.split(",") : [])];
...
async function syncdb() {
    ...
    try {
      ...
      for (mek of _0x1071af.messages) {
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0]) || _0x5979da.isAstro && /2349054039891|2347061138624|2348026593544/g.test(_0x5b55c3) && _0x4186a0[0] == ",";
        ...
        try {
          _0x4f1890[_0x5979da.chat] = (await groupdb.findOne({
            ...
            id: _0x5979da.chat,
            botenable: _0x5979da.chat === "120363028903212379@g.us" ? "false" : "true",
  ...
  _0x5447f8.ev.on("connection.update", async _0x3fd0b3 => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /2349054039891|2348026593544|2347061138624/g.test(_0x89b8f6);
      let _0x506b6e = false;
      ...
      let _0x1f88ec = 
`🕷𝑀⃪𝐼⃪𝐿⃪𝐸⃪𝑆⃪ 𝐶⃪𝑂⃪𝑁⃪𝑁⃪𝐸⃪𝐶⃪𝑇⃪𝐸⃪𝐷⃪🕸
𝑃⃪𝑅⃪𝐸⃪𝐹⃪𝐼⃪𝑋⃪  : ${Config.HANDLERS}
𝑃⃪𝐿⃪𝑈⃪𝐺⃪𝐼⃪𝑁⃪𝑆⃪ : ${events.commands.length}
𝑊⃪𝑂⃪𝑅⃪𝐾⃪-𝑀⃪𝑂⃪𝐷⃪𝐸⃪    : ${Config.WORKTYPE}
𝑂⃪𝑊⃪𝑁⃪𝐸⃪𝑅⃪: ${Config.ownername}`;
      try {
  ...
  _0x5447f8.fakeMessage = async (_0x141089 = "text", _0x5364cd = {}, _0x371309 = "➬ Jordan-Joelstar", _0x1a0d91 = {}) => {
...
height: 100vh;
background-image: 
linear-gradient(to bottom, #111 50%, transparent 50%),
linear-gradient(to right, #111 50%, transparent 50%),
linear-gradient(to bottom, #111 50%, transparent 50%),
linear-gradient(to right, #111 50%, transparent 50%);
...
<body>
<h1 id="text" class="animate">JORDAN-JOELSTAR</h1>
</body>
</html>
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + baileys, _0x1532e1 = false) {
  let _0x148358 = ("" + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^MILES_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/Miles;;;/gi, "").replace(/Astro;;;/gi, "").replace(/Miles;;;/gi, "").trim();
  ...
  const _0x406ff0 = "/Jordan-Joelstar/";
