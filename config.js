...
module.exports = {
  ...
  caption: process.env.CAPTION || "©*•|✺͜͡➳⭗⎼ͥ͢⎼⎼ͣ⎼⎼ͫ𝑱𝑼𝑵𝑨𝑰𝑫*•",
  author: process.env.PACK_AUTHER || "*•|✺͜͡➳⭗⎼ͥ͢⎼⎼ͣ⎼⎼ͫ𝑱𝑼𝑵𝑨𝑰𝑫*•",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "*•|✺͜͡➳⭗⎼ͥ͢⎼⎼ͣ⎼⎼ͫ𝑱𝑼𝑵𝑨𝑰𝑫*•",
  ownername: process.env.OWNER_NAME || "*•|✺͜͡➳⭗⎼ͥ͢⎼⎼ͣ⎼⎼ͫ𝑱𝑼𝑵𝑨𝑰𝑫*•",
